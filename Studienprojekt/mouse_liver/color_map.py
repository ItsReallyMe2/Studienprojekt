...
'''Custom_cmap'''
c = ['#a6cee3','#77b3a9','#1f78b4','#ffffb3','#b2df8a','#bebada','#33a02c','#fb8072','#fb9a99',
          '#80b1d3','#e31a1c','#fdb462','#d9a462','#b3de69','#ff7f00','#fccde5','#cab2d6','#d9d9d9','#6a3d9a','#bc80bd','#ffff99','#ccebc5','#b15928','#ffed6f']
c_34 = [
